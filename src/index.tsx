  ...
  return (
    <Focusable
      ...
      navEntryPreferPosition={
        screen === 'item' ? NavEntryPositionPreferences.PREFERRED_CHILD : undefined
      }
      style={{ display: 'contents' }}
    >
      <div ref={contentTopRef}>
        {playerState.nowPlaying && (
          <PlayerView state={playerState} onStopped={() => setPlayerState(EMPTY_PLAYER_STATE)} />
        )}
        ...
        {screen === 'login' && <LoginView onLoggedIn={() => setScreen('libraries')} />}
